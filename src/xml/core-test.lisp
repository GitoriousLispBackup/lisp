...
(deftest core-test attribute-test ()
...
(deftest core-test remove-attribute-test ()
  (let ((node (make-instance 'xml-node :attributes '((a . 0)(b . 1)))))
...
(deftest core-test node-print-test ()
...
(deftest core-test print-childs-test ()
